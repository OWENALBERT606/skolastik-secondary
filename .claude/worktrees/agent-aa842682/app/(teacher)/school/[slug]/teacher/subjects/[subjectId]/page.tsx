...
import SubjectDetailClient           from "@/app/(school)/school/[slug]/academics/streams/[id]/subjects/[subjectId]/components/stream-subject-detail-client";
...
export default async function TeacherSubjectPage({
  ...
  if (!isAssigned) redirect(`/school/${slug}/teacher/dashboard`);
