...
import AcademicTermsList from "./components/academic-terms-list";
    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
          <p className="text-red-800 dark:text-red-400">No school found for this user.</p>
        </div>
      </div>
    );
  }

  const result = await getAcademicTermsWithStats(schoolId);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Manage academic terms for all academic years
          </p>
        </div>
      </div>
