...
export default function ExpensesPage({
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setDrawerErr(e instanceof Error ? e.message : "Failed to create expense.");
  ...
  return (
    <div className="min-h-screen w-[980px]  bg-slate-50">
      ...
      {/* ══ DRAWER: New Expense ══════════════════════════════════════════════ */}
      <SlideDrawer open={drawer} onClose={() => setDrawer(false)} title="New Expense" subtitle="Record a new school expenditure">
