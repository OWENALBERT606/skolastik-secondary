...
const ReUsableHero: React.FC<HeroProps> = ({
  ...
  const backgroundStyles = {
    ...
    purple: {
      ...
      gradient: "from-fuchsia-400 via-blue-400 to-violet-400",
      blur: ["bg-blue-500/30", "bg-fuchsia-500/20", "bg-violet-500/20"],
      floating:
        theme === "light"
          ? "bg-blue-100/50 border-blue-200"
          : "bg-blue-900/50 border-blue-800",
  ...
  const getIconPosition = (position: string) => {
    switch (position) {
      ...
      default:
        return "left-1/2 -top-14 rotate-12 hover:-rotate-12";
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-16 md:pt-32 sm:px-6 lg:px-8">
        {announcement && (
        ...
        <div className="relative text-center max-w-4xl mx-auto mb-20">
          ...
          <div className="pt-8 pb-4 flex items-center  justify-center gap-8">
            ...
            <div className="">
              <StarRating count={5} />
              <p className="dark:text-slate-900">{300} developers use it.</p>
            </div>
          </div>
        </div>
      </div>
