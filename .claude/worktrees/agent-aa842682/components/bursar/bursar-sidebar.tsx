...
import {
  ...
  KeyRound, Settings, User, DollarSign, ClipboardList,
  ...
  return [
    {
      items: [
        {
          title: "Dashboard",
          url:   `/school/${slug}/bursar/dashboard`,
          icon:  LayoutDashboard,
          isActive: true,
          items: [{ title: "Overview", url: `/school/${slug}/bursar/dashboard` }],
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon:  DollarSign,
          items: [
            { title: "Overview",            url: `${fin}/fees`,                icon: BarChart3       },
            { title: "Fee Categories",      url: `${fin}/fees/categories`,     icon: Tag             },
            { title: "Fee Structures",      url: `${fin}/fees/structures`,     icon: Layers          },
            { title: "Auto-Invoice Config", url: `${fin}/fees/config`,         icon: Settings        },
            { title: "Penalty Rules",       url: `${fin}/fees/penalties`,      icon: AlertCircle     },
          ],
        },
        {
          title: "Student Accounts",
          url:   `${fin}/fees/accounts`,
          icon:  Users,
          items: [
            { title: "All Accounts",   url: `${fin}/fees/accounts` },
            { title: "Bursaries",      url: `${fin}/fees/bursaries`,    icon: DollarSign },
            { title: "Installments",   url: `${fin}/fees/installments`, icon: ClipboardList },
          ],
        },
        {
          title: "Invoices & Payments",
          url:   `${fin}/fees/invoices`,
          icon:  FileText,
          items: [
            { title: "Invoices",       url: `${fin}/fees/invoices`,  icon: FileText },
            { title: "Payments",       url: `${fin}/fees/payments`,  icon: Receipt  },
            { title: "Reports",        url: `${fin}/fees/reports`,   icon: BarChart3 },
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          icon:  TrendingUp,
          items: [
            { title: "Expense Records", url: `${fin}/expense` },
            { title: "Vendors",         url: `${fin}/expense/vendors` },
            { title: "Categories",      url: `${fin}/expense/categories` },
          ],
        },
        {
          title: "Inventory",
          ...
          icon:  ShoppingCart,
          items: [
            { title: "Stock Overview", url: `${fin}/inventory` },
          ],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "Students",
          url:   `${sch}/users/students`,
          icon:  BookOpen,
          items: [
            { title: "All Students", url: `${sch}/users/students` },
          ],
        },
        {
          title: "Parents",
          url:   `${sch}/users/parents`,
          icon:  Users,
          items: [
            { title: "All Parents", url: `${sch}/users/parents` },
          ],
        },
      ],
    },
    {
      ...
      items: [
        {
          title: "Communication",
          url:   `${sch}/communication/messages`,
          icon:  Mail,
          items: [
            { title: "Inbox",    url: `${sch}/communication/inbox`,    icon: Inbox },
            { title: "Messages", url: `${sch}/communication/messages`, icon: MessageSquare },
          ],
        },
      ],
    },
          ...
          <SidebarGroup key={gi} className="py-1">
            ...
            <SidebarMenu className="gap-1">
              {group.items.map(item => {
                const isOpen = pathname.startsWith(item.url.split("?")[0].replace("/dashboard", ""));
                return (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent side="top" align="start"
                ...
                <DropdownMenuItem asChild className="gap-2 px-3 py-2 text-sm cursor-pointer text-zinc-700 dark:text-zinc-300 focus:bg-zinc-50 dark:focus:bg-slate-800/60">
                  <Link href={`/school/${school.slug}/bursar/profile`}>
